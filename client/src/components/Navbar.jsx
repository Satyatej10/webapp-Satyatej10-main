// Navbar component with solid background
...
const Navbar = () => {
  return (
    <nav className="absolute top-0 left-0 right-0 p-6 z-10 backdrop-blur-md">
      <div className="flex items-center justify-between">
        ...
        {/* Right-side content: Home and Restaurants buttons */}
